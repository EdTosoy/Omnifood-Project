    ...
    <main className="max-h-screen grid py-20 text-gray-600 bg-gray-100" id="works">
      ...
      <div className=" grid grid-cols-2 justify-center">
        <div className="text-right">
          <Image src="/images/app-iPhone.png" width={230} height={430} />
        </div>
        <div className="flex-col flex justify-center">
          ...
          <div className="mt-14 flex">
            <div className="relative w-36 h-14 ml-6">
              <Image src="/images/download-app-android.png" layout="fill" />
            </div>
            <div className="relative w-40 h-14 ml-6">
              <Image src="/images/download-app.svg" layout="fill" />
            </div>
          </div>
        </div>
      </div>
